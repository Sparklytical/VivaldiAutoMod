...
window.gnoh = Object.assign(window.gnoh || {}, {
  encode: {
    html: function (rawStr) {
      return !rawStr
        ? rawStr
        : rawStr.replace(/[\u00A0-\u9999<>\&"'%]/gi, function (i) {
  ...
  override: function (obj, functionName, callback, conditon) {
    obj[functionName] = (function (_super) {
      return function () {
        var result;
        if (
          (typeof conditon === "function" && conditon.apply(this, arguments)) ||
          conditon === undefined ||
          conditon === true
        ) {
...
(function () {
  ...
  function createPatternSearchEngines(searchEngineCollection) {
    ...
    const engines = searchEngineCollection.engines.filter(
      (e) => e.removed !== true
    );
    if (engines.length > 0) {
      const regKeywords = [];
      engines.forEach(function (engine) {
        ...
        searchEngines.engines[engine.keyword].keywordHTML = gnoh.encode.html(
          engine.keyword
        );
        searchEngines.engines[engine.keyword].nameHTML = gnoh.encode.html(
          engine.name
        );
        regKeywords.push(
          engine.keyword.replace(/[-/\\^$*+?.()|[]{}]/g, "\\$&")
        );
  ...
  function createPatternExtensions(extensionCollection, callback) {
    ...
    if (extensionCollection.length > 0) {
      ...
      pattern.url.host.extensions = new RegExp(
        "^(?=[a-z]{32})(?:(" + regKeywords.join("|") + "))$",
        "i"
      );
    }
  ...
  function createMask(addressfieldEl, addressfieldParentEl) {
    ...
    const addressfieldMaskEl = gnoh.createElement(
      "div",
      {
    ...
    ["onEnabled", "onDisabled", "onInstalled", "onUninstalled"].forEach(
      function (event) {
  ...
  function getURLColorEl(url) {
    ...
    if (arr) {
      ...
      return [
        typeof urlConvert.protocolSub !== "undefined"
          ? '<div class="protocol-sub" data-protocol-sub="' +
            urlConvert.protocolSubHTML +
            '">' +
            urlConvert.protocolSubHTML +
            "</div>"
          : "",
        typeof urlConvert.protocol !== "undefined"
          ? '<div class="protocol" data-protocol="' +
            urlConvert.protocolHTML +
            '">' +
            urlConvert.protocolHTML +
            "</div>"
          : "",
        typeof urlConvert.hostFull !== "undefined"
          ? [
              '<div class="host-full" data-host-full="' +
                urlConvert.hostFullHTML +
                '">',
              typeof urlConvert.host !== "undefined"
                ? getURLHostEl(urlConvert.host, urlConvert)
                : "",
              typeof urlConvert.postFull !== "undefined"
          ...
          : "",
        typeof urlConvert.path !== "undefined" ||
        typeof urlConvert.search !== "undefined" ||
        typeof urlConvert.hashFull !== "undefined"
          ? [
              '<div class="path-full">',
              urlConvert.path === "/"
              ...
              urlConvert.search === "?"
                ...
                ? '<div class="search" data-search="' +
                  urlConvert.searchHTML +
                  '">' +
                  getURLSearchEl(urlConvert.search) +
                  "</div>"
                : "",
              typeof urlConvert.hashFull !== "undefined"
                ? '<div class="hash" data-hash="' +
                  urlConvert.hashFullHTML +
                  '">' +
                  (enableDecodeURL === true
                    ? decodeURIComponent(urlConvert.hashHTML)
                    : urlConvert.hashHTML) +
                  "</div>"
                : "",
              "</div>",
    ...
    if (host.match(pattern.url.host.hostSub.topLevel2)) {
      ...
      return host.replace(pattern.url.host.hostSub.topLevel2, function (
        ...
        return [
          ...
          typeof hostSub !== "undefined"
            ? '<div class="host-sub" data-host-sub="' +
              hostSubHTML +
              '">' +
              hostSubHTML +
              "</div>"
            : "",
          typeof hostMain !== "undefined"
            ? '<div class="host-main" data-host-main="' +
              hostMainHTML +
              '">' +
              hostMainHTML +
              "</div>"
      ...
      let hostSubHTML, hostMainHTML;
      return host.replace(pattern.url.host.hostSub.topLevel1, function (
        match,
        hostSubFull,
        hostSub,
        hostMain
      ...
      let searchQueryHTML;
      return host.replace(pattern.searchEngines, function (
        match,
        searchNickname,
        searchQuery
      ) {
        ...
        return [
          ...
          typeof searchNickname !== "undefined"
            ? '<div class="search-nickname" data-search-nickname="' +
              searchEngines.engines[searchNickname].keywordHTML +
              '" data-search-name="' +
              searchEngines.engines[searchNickname].nameHTML +
              '">' +
              searchEngines.engines[searchNickname].keywordHTML +
              "</div>"
            : "",
          typeof searchQuery !== "undefined"
            ? '<div class="search-query" data-search-query="' +
              searchQueryHTML +
              '">' +
              (enableDecodeURL === true
                ? decodeURIComponent(searchQueryHTML)
                : searchQueryHTML) +
              "</div>"
            : "",
          "</div>",
      ...
      typeof urlConvert.protocol !== "chrome-extension" &&
      pattern.url.host.extensions &&
      host.match(pattern.url.host.extensions)
    ) {
      return (
        '<div class="host extension" data-host="' +
        urlConvert.hostHTML +
        '"><div class="host-extension" data-host-extension="' +
        urlConvert.hostHTML +
        '" data-host-extension-name="' +
        extensions[host].nameHTML +
        '">' +
        urlConvert.hostHTML +
        "</div></div>"
      );
      ...
      return (
        '<div class="host other" data-host="' +
        urlConvert.hostHTML +
        '"><div class="host-other" data-host-other="' +
        urlConvert.hostHTML +
        '">' +
        urlConvert.hostHTML +
        "</div></div>"
      ...
      const searchDefault = isPrivate
        ? searchEngines.defaultPrivate
        : searchEngines.default;
      return (
        '<div class="search-engine default" data-search-nickname-default="' +
        searchDefault.keywordHTML +
        '" data-search-name-default="' +
        searchDefault.nameHTML +
        '"><div class="search-query" data-search-query="' +
        urlConvert.hostHTML +
        '">' +
        urlConvert.hostHTML +
  ...
  function getURLPathEl(path) {
    ...
    return path.replace(pattern.url.path, function (match, pathItem) {
      ...
      return typeof match !== "undefined"
        ? '<div class="path-item" data-path-item="' +
            pathItemHTML +
            '">' +
            (enableDecodeURL === true
              ? decodeURIComponent(pathItemHTML)
              : pathItemHTML) +
            "</div>"
        : "";
    });
  ...
  function getURLSearchEl(search) {
    ...
    return search.replace(pattern.url.search, function (
      match,
      key,
      valueFull,
      value
      ...
      return [
        ...
        typeof key !== "undefined"
          ? '<div class="search-key" data-search-key="' +
            keyHTML +
            '">' +
            (enableDecodeURL === true ? decodeURIComponent(keyHTML) : keyHTML) +
            "</div>"
          : "",
        typeof valueFull !== "undefined"
          ? '<div class="search-value" data-search-value="' +
            valueHTML +
            '">' +
            (enableDecodeURL === true
              ? decodeURIComponent(valueHTML)
              : valueHTML) +
            "</div>"
          : "",
        "</div>",
  ...
  gnoh.timeOut(function (addressfieldEl) {
    ...
    gnoh.override(HTMLElement.prototype, "appendChild", function (element) {
      ...
      if (
        this[key] &&
        this[key].className === "UrlField" &&
        element[key] &&
        element[key].className.indexOf("url vivaldi-addressfield") > -1
      ) {
